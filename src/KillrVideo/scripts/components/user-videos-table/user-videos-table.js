define(["knockout", "text!./user-videos-table.tmpl.html", "lib/knockout-moment-text"], function (ko, htmlString) {
    // View model for the user videos table
    function userVideosViewModel(params) {
        var self = this;
    ...
    return { viewModel: userVideosViewModel, template: htmlString };
});